...
{
    public static class CallbackShowHideScriptGenerator
    {
        [MenuItem("Assets/Create/Scripting/ShowHide/MonoShowHide UniTask")]
...
public sealed class #CLASSNAME# : MonoShowHide
{
    ...
    private void Awake()
    {
        _showHide = new ShowHideUniTaskStateMachine(
            _initialState,
            _ignoreState,
            OnShow,
            OnHide,
    ...
    private UniTask OnShow(CancellationToken token)
    { throw new NotImplementedException(); }
    private void OnSetShown() 
    { }
    private UniTask OnHide(CancellationToken token)
    { throw new NotImplementedException(); }
